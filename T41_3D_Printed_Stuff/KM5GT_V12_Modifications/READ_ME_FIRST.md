The following directories contain both the original KF5N FreeCAD files for printing the T-41 v10 and v11 case along with a directory for modifications I made to some of the files for v12.  
