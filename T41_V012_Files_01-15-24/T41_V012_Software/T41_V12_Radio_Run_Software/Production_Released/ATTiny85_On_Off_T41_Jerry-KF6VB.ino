...
// Therefore, plagerize and modify away!  No warranty.  Just give me a
// little credit.
//
// 7/21/2024 Modified by Jerry Kaidor, KF6VB to "hiccup" the power-on, which
// fixes the video INOP after long power-down problem.
//
